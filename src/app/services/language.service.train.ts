  ...
  private content: { [key: string]: LearningContent } = {
    ...
    uk: {
      ...
      sentences: {
        ...
        'Do you speak English?': 'Ви розмовляєте англійською? (Vy rozmovliaiete anhliiskoiu?)',
        'Where is the bathroom?': 'Де знаходиться ванна кімната? (De znakhodytsia vanna kimnata?)',
        // Practical Phrases
