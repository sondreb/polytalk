  ...
  private content: { [key: string]: LearningContent } = {
    ...
    sr: {
      ...
      sentences: {
        ...
        'Where is the bathroom?': 'Где је купатило? (Gde je купатило?)',
        // Practical Phrases
    ...
    me: {
      ...
      sentences: {
        ...
        'Do you speak English?':
          'Да ли говорите енглески? (Da li govorите енглески?)',
        'Where is the bathroom?': 'Ђе је купатило? (Đе је купатило?)',
        // Practical Phrases
        'How much does it cost?': 'Колико кошта? (Koliko košta?)',
        'Can you help me?': 'Можете ли ми помоћи? (Možete ли ми помоћ��?)',
