...
const EN_TRANSLATIONS: TranslationKeys = {
  ...
  'langSelect.search': 'Search languages',
  'langSelect.noResults': 'No languages found',
...
const ES_TRANSLATIONS: TranslationKeys = {
  ...
  'learning.options': 'Opciones',
  'learning.close': 'Cerrar',
  'learning.swap': 'Intercambiar idiomas',
  'learning.from': 'De',
  'learning.to': 'A',
  'learning.listen': 'Escuchar',
  'langSelect.favorites': 'Favoritos',
  'langSelect.allLanguages': 'Todos los Idiomas',
  'langSelect.search': 'Buscar idiomas',
  'langSelect.noResults': 'No se encontraron idiomas',
...
const FR_TRANSLATIONS: TranslationKeys = {
  ...
  'learning.options': 'Options',
  'learning.close': 'Fermer',
  'learning.swap': 'Inverser les langues',
  'learning.from': 'De',
  'learning.to': 'Vers',
  'learning.listen': 'Écouter',
  'langSelect.favorites': 'Favoris',
  'langSelect.allLanguages': 'Toutes les Langues',
  'langSelect.search': 'Rechercher une langue',
  'langSelect.noResults': 'Aucune langue trouvée',
...
const DE_TRANSLATIONS: TranslationKeys = {
  ...
  'learning.options': 'Optionen',
  'learning.close': 'Schließen',
  'learning.swap': 'Sprachen tauschen',
  'learning.from': 'Von',
  'learning.to': 'Nach',
  'learning.listen': 'Anhören',
  'langSelect.favorites': 'Favoriten',
  'langSelect.allLanguages': 'Alle Sprachen',
  'langSelect.search': 'Sprachen suchen',
  'langSelect.noResults': 'Keine Sprachen gefunden',
...
const ZH_TRANSLATIONS: TranslationKeys = {
  ...
  'langSelect.search': '搜索语言',
  'langSelect.noResults': '未找到语言',
...
const JA_TRANSLATIONS: TranslationKeys = {
  ...
  'learning.options': 'オプション',
  'learning.close': '閉じる',
  'learning.swap': '言語を入れ替える',
  'learning.from': '元の言語',
  'learning.to': '学習言語',
  'learning.listen': '再生',
  'langSelect.favorites': 'お気に入り',
  'langSelect.allLanguages': 'すべての言語',
  'langSelect.search': '言語を検索',
  'langSelect.noResults': '言語が見つかりません',
...
const PT_TRANSLATIONS: TranslationKeys = {
  ...
  'learning.options': 'Opções',
  'learning.close': 'Fechar',
  'learning.swap': 'Trocar idiomas',
  'learning.from': 'De',
  'learning.to': 'Para',
  'learning.listen': 'Ouvir',
  'langSelect.favorites': 'Favoritos',
  'langSelect.allLanguages': 'Todos os Idiomas',
  'langSelect.search': 'Pesquisar idiomas',
  'langSelect.noResults': 'Nenhum idioma encontrado',
...
const AR_TRANSLATIONS: TranslationKeys = {
  ...
  'learning.options': 'خيارات',
  'learning.close': 'إغلاق',
  'learning.swap': 'تبديل اللغتين',
  'learning.from': 'من',
  'learning.to': 'إلى',
  'learning.listen': 'استماع',
  'langSelect.favorites': 'المفضلة',
  'langSelect.allLanguages': 'جميع اللغات',
  'langSelect.search': 'ابحث عن اللغات',
  'langSelect.noResults': 'لم يتم العثور على لغات',
...
const NO_TRANSLATIONS: TranslationKeys = {
  ...
  'learning.options': 'Alternativer',
  'learning.close': 'Lukk',
  'learning.swap': 'Bytt språk',
  'learning.from': 'Fra',
  'learning.to': 'Til',
  'learning.listen': 'Lytt',
  'langSelect.favorites': 'Favoritter',
  'langSelect.allLanguages': 'Alle Språk',
  'langSelect.search': 'Søk etter språk',
  'langSelect.noResults': 'Fant ingen språk',
...
const KO_TRANSLATIONS: TranslationKeys = {
  ...
  'learning.options': '옵션',
  'learning.close': '닫기',
  'learning.swap': '언어 바꾸기',
  'learning.from': '원본 언어',
  'learning.to': '학습 언어',
  'learning.listen': '듣기',
  'langSelect.favorites': '즐겨찾기',
  'langSelect.allLanguages': '모든 언어',
  'langSelect.search': '언어 검색',
  'langSelect.noResults': '언어를 찾을 수 없습니다',
...
const HI_TRANSLATIONS: TranslationKeys = {
  ...
  'learning.options': 'विकल्प',
  'learning.close': 'बंद करें',
  'learning.swap': 'भाषाएँ बदलें',
  'learning.from': 'से',
  'learning.to': 'तक',
  'learning.listen': 'सुनें',
  'langSelect.favorites': 'पसंदीदा',
  'langSelect.allLanguages': 'सभी भाषाएँ',
  'langSelect.search': 'भाषाएँ खोजें',
  'langSelect.noResults': 'कोई भाषा नहीं मिली',
