...
const EN_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.statusUnlocked': 'Premium is unlocked. Extra words, numbers, and sentences are included.',
  'premium.statusLocked': 'Unlock extra travel words, numbers, and phrases',
  'premium.pitch': 'Get more everyday vocabulary with a one-time Google Play purchase. Not a subscription.',
  'premium.buy': 'Unlock Premium',
  'premium.buyOnPlay': 'Buy on Google Play',
  'premium.restore': 'Restore purchase',
  'premium.restoring': 'Restoring...',
  'premium.purchasing': 'Opening Google Play...',
  'premium.restored': 'Purchase restored.',
  'premium.alreadyUnlocked': 'Premium is already unlocked.',
  'premium.nothingToRestore': 'No Google Play purchase found. Restore from the Android app if you already bought Premium.',
  'premium.webOnly': 'Purchases are handled by Google Play in the Android app. This page will not charge you.',
  'premium.error': 'Could not complete that request. Try again, or restore your purchase.',
  'premium.cancelled': 'Purchase cancelled.',
  'premium.teaserTitle': 'More words and phrases',
  'premium.teaserBody': 'Premium adds extra everyday vocabulary and travel sentences. One-time unlock, yours forever.',
  'premium.lockedItem': 'Premium',
  'premium.unlockedBadge': 'Premium unlocked',
  'premium.devHint': 'Development only: localStorage key polytalk-premium=1 unlocks the extra pack. This is not a real payment.',
...
const ES_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.title': 'Premium',
  'premium.statusUnlocked': 'Premium esta desbloqueado. Incluye palabras, numeros y frases extra.',
  'premium.statusLocked': 'Desbloquea mas palabras, numeros y frases de viaje',
  'premium.pitch': 'Consigue mas vocabulario cotidiano con una compra unica en Google Play. No es una suscripcion.',
  'premium.buy': 'Desbloquear Premium',
  'premium.buyOnPlay': 'Comprar en Google Play',
  'premium.restore': 'Restaurar compra',
  'premium.restoring': 'Restaurando...',
  'premium.purchasing': 'Abriendo Google Play...',
  'premium.restored': 'Compra restaurada.',
  'premium.alreadyUnlocked': 'Premium ya esta desbloqueado.',
  'premium.nothingToRestore': 'No se encontro una compra de Google Play. Restaura desde la app de Android si ya compraste Premium.',
  'premium.webOnly': 'Las compras las gestiona Google Play en la app de Android. Esta pagina no te cobrara.',
  'premium.error': 'No se pudo completar la solicitud. Intentalo de nuevo o restaura tu compra.',
  'premium.cancelled': 'Compra cancelada.',
  'premium.teaserTitle': 'Mas palabras y frases',
  'premium.teaserBody': 'Premium anade vocabulario cotidiano y frases de viaje. Un solo pago, para siempre.',
  'premium.lockedItem': 'Premium',
  'premium.unlockedBadge': 'Premium desbloqueado',
  'premium.devHint': 'Solo desarrollo: la clave localStorage polytalk-premium=1 desbloquea el pack extra. No es un pago real.',
...
const FR_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.title': 'Premium',
  'premium.statusUnlocked': 'Premium est debloque. Les mots, nombres et phrases extra sont inclus.',
  'premium.statusLocked': 'Debloquez plus de mots, nombres et phrases de voyage',
  'premium.pitch': 'Ajoutez du vocabulaire du quotidien avec un achat unique sur Google Play. Pas d un abonnement.',
  'premium.buy': 'Debloquer Premium',
  'premium.buyOnPlay': 'Acheter sur Google Play',
  'premium.restore': 'Restaurer l achat',
  'premium.restoring': 'Restauration...',
  'premium.purchasing': 'Ouverture de Google Play...',
  'premium.restored': 'Achat restaure.',
  'premium.alreadyUnlocked': 'Premium est deja debloque.',
  'premium.nothingToRestore': 'Aucun achat Google Play trouve. Restaurez depuis l application Android si vous avez deja achete Premium.',
  'premium.webOnly': 'Les achats sont geres par Google Play dans l application Android. Cette page ne vous facturera pas.',
  'premium.error': 'Impossible de terminer la demande. Reessayez ou restaurez votre achat.',
  'premium.cancelled': 'Achat annule.',
  'premium.teaserTitle': 'Plus de mots et de phrases',
  'premium.teaserBody': 'Premium ajoute du vocabulaire quotidien et des phrases de voyage. Achat unique, a vie.',
  'premium.lockedItem': 'Premium',
  'premium.unlockedBadge': 'Premium debloque',
  'premium.devHint': 'Developpement uniquement : la cle localStorage polytalk-premium=1 debloque le pack extra. Ce n est pas un vrai paiement.',
...
const DE_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.title': 'Premium',
  'premium.statusUnlocked': 'Premium ist freigeschaltet. Extra-Woerter, Zahlen und Saetze sind enthalten.',
  'premium.statusLocked': 'Schalte extra Reisewoerter, Zahlen und Saetze frei',
  'premium.pitch': 'Mehr Alltagswortschatz mit einem einmaligen Google-Play-Kauf. Kein Abo.',
  'premium.buy': 'Premium freischalten',
  'premium.buyOnPlay': 'Bei Google Play kaufen',
  'premium.restore': 'Kauf wiederherstellen',
  'premium.restoring': 'Wird wiederhergestellt...',
  'premium.purchasing': 'Google Play wird geoeffnet...',
  'premium.restored': 'Kauf wiederhergestellt.',
  'premium.alreadyUnlocked': 'Premium ist bereits freigeschaltet.',
  'premium.nothingToRestore': 'Kein Google-Play-Kauf gefunden. Stelle ihn in der Android-App wieder her, wenn du Premium schon gekauft hast.',
  'premium.webOnly': 'Kaeufe laufen ueber Google Play in der Android-App. Diese Seite berechnet nichts.',
  'premium.error': 'Die Anfrage konnte nicht abgeschlossen werden. Versuche es erneut oder stelle den Kauf wieder her.',
  'premium.cancelled': 'Kauf abgebrochen.',
  'premium.teaserTitle': 'Mehr Woerter und Saetze',
  'premium.teaserBody': 'Premium ergaenzt Alltagswortschatz und Reisesaetze. Einmalig freischalten, fuer immer.',
  'premium.lockedItem': 'Premium',
  'premium.unlockedBadge': 'Premium freigeschaltet',
  'premium.devHint': 'Nur fuer die Entwicklung: Der localStorage-Schluessel polytalk-premium=1 schaltet das Extra-Paket frei. Das ist keine echte Zahlung.',
...
const ZH_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.title': '高级版',
  'premium.statusUnlocked': '高级版已解锁。额外的单词、数字和句子已包含。',
  'premium.statusLocked': '解锁更多旅行单词、数字和句子',
  'premium.pitch': '通过 Google Play 一次性购买获取更多日常词汇。不是订阅。',
  'premium.buy': '解锁高级版',
  'premium.buyOnPlay': '在 Google Play 购买',
  'premium.restore': '恢复购买',
  'premium.restoring': '正在恢复...',
  'premium.purchasing': '正在打开 Google Play...',
  'premium.restored': '已恢复购买。',
  'premium.alreadyUnlocked': '高级版已经解锁。',
  'premium.nothingToRestore': '未找到 Google Play 购买记录。如果你已经购买，请在 Android 应用中恢复。',
  'premium.webOnly': '购买由 Android 应用中的 Google Play 处理。此页面不会向你收费。',
  'premium.error': '无法完成该请求。请重试或恢复购买。',
  'premium.cancelled': '已取消购买。',
  'premium.teaserTitle': '更多单词和句子',
  'premium.teaserBody': '高级版增加日常词汇和旅行句子。一次解锁，永久使用。',
  'premium.lockedItem': '高级版',
  'premium.unlockedBadge': '高级版已解锁',
  'premium.devHint': '仅供开发：localStorage 键 polytalk-premium=1 可解锁额外内容。这不是真实付款。',
...
const JA_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.title': 'プレミアム',
  'premium.statusUnlocked': 'プレミアムが解除されています。追加の単語、数字、文が含まれます。',
  'premium.statusLocked': '旅行向けの追加単語、数字、文を解除',
  'premium.pitch': 'Google Play の買い切りで日常語彙を追加できます。定期購入ではありません。',
  'premium.buy': 'プレミアムを解除',
  'premium.buyOnPlay': 'Google Play で購入',
  'premium.restore': '購入を復元',
  'premium.restoring': '復元中...',
  'premium.purchasing': 'Google Play を開いています...',
  'premium.restored': '購入を復元しました。',
  'premium.alreadyUnlocked': 'プレミアムはすでに解除されています。',
  'premium.nothingToRestore': 'Google Play の購入が見つかりません。すでに購入済みなら Android アプリで復元してください。',
  'premium.webOnly': '購入は Android アプリの Google Play で処理されます。このページでは課金しません。',
  'premium.error': 'リクエストを完了できませんでした。再試行するか、購入を復元してください。',
  'premium.cancelled': '購入をキャンセルしました。',
  'premium.teaserTitle': 'さらに単語と文',
  'premium.teaserBody': 'プレミアムは日常語彙と旅行の文を追加します。一度の解除でずっと使えます。',
  'premium.lockedItem': 'プレミアム',
  'premium.unlockedBadge': 'プレミアム解除済み',
  'premium.devHint': '開発専用: localStorage キー polytalk-premium=1 で追加パックを解除できます。実際の支払いではありません。',
...
const PT_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.title': 'Premium',
  'premium.statusUnlocked': 'O Premium esta desbloqueado. Palavras, numeros e frases extra estao incluidos.',
  'premium.statusLocked': 'Desbloqueie mais palavras, numeros e frases de viagem',
  'premium.pitch': 'Obtenha mais vocabulario do dia a dia com uma compra unica no Google Play. Nao e uma assinatura.',
  'premium.buy': 'Desbloquear Premium',
  'premium.buyOnPlay': 'Comprar no Google Play',
  'premium.restore': 'Restaurar compra',
  'premium.restoring': 'A restaurar...',
  'premium.purchasing': 'A abrir o Google Play...',
  'premium.restored': 'Compra restaurada.',
  'premium.alreadyUnlocked': 'O Premium ja esta desbloqueado.',
  'premium.nothingToRestore': 'Nenhuma compra do Google Play encontrada. Restaure na app Android se ja comprou o Premium.',
  'premium.webOnly': 'As compras sao tratadas pelo Google Play na app Android. Esta pagina nao lhe cobra.',
  'premium.error': 'Nao foi possivel concluir o pedido. Tente novamente ou restaure a compra.',
  'premium.cancelled': 'Compra cancelada.',
  'premium.teaserTitle': 'Mais palavras e frases',
  'premium.teaserBody': 'O Premium acrescenta vocabulario quotidiano e frases de viagem. Desbloqueio unico, para sempre.',
  'premium.lockedItem': 'Premium',
  'premium.unlockedBadge': 'Premium desbloqueado',
  'premium.devHint': 'Apenas para desenvolvimento: a chave localStorage polytalk-premium=1 desbloqueia o pack extra. Nao e um pagamento real.',
...
const AR_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.title': 'المميز',
  'premium.statusUnlocked': 'تم فتح النسخة المميزة. الكلمات والارقام والجمل الاضافية مضمنة.',
  'premium.statusLocked': 'افتح المزيد من كلمات السفر والارقام والجمل',
  'premium.pitch': 'احصل على مزيد من المفردات اليومية بشراء لمرة واحدة من Google Play. ليست اشتراكا.',
  'premium.buy': 'فتح المميز',
  'premium.buyOnPlay': 'الشراء من Google Play',
  'premium.restore': 'استعادة الشراء',
  'premium.restoring': 'جار الاستعادة...',
  'premium.purchasing': 'جار فتح Google Play...',
  'premium.restored': 'تمت استعادة الشراء.',
  'premium.alreadyUnlocked': 'النسخة المميزة مفتوحة بالفعل.',
  'premium.nothingToRestore': 'لم يتم العثور على شراء من Google Play. استعد من تطبيق Android اذا كنت قد اشتريت المميز.',
  'premium.webOnly': 'تتم عمليات الشراء عبر Google Play في تطبيق Android. هذه الصفحة لن تخصم منك.',
  'premium.error': 'تعذر اكمال الطلب. حاول مرة اخرى او استعد الشراء.',
  'premium.cancelled': 'تم الغاء الشراء.',
  'premium.teaserTitle': 'مزيد من الكلمات والجمل',
  'premium.teaserBody': 'يضيف المميز مفردات يومية وجمل سفر. فتح لمرة واحدة ويدوم.',
  'premium.lockedItem': 'المميز',
  'premium.unlockedBadge': 'المميز مفتوح',
  'premium.devHint': 'للتطوير فقط: مفتاح localStorage المسمى polytalk-premium=1 يفتح الحزمة الاضافية. هذا ليس دفعا حقيقيا.',
...
const NO_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.title': 'Premium',
  'premium.statusUnlocked': 'Premium er låst opp. Ekstra ord, tall og setninger er inkludert.',
  'premium.statusLocked': 'Lås opp flere reiseord, tall og setninger',
  'premium.pitch': 'Få mer hverdagsvokabular med et engangskjøp på Google Play. Ikke et abonnement.',
  'premium.buy': 'Lås opp Premium',
  'premium.buyOnPlay': 'Kjøp på Google Play',
  'premium.restore': 'Gjenopprett kjøp',
  'premium.restoring': 'Gjenoppretter...',
  'premium.purchasing': 'Åpner Google Play...',
  'premium.restored': 'Kjøpet er gjenopprettet.',
  'premium.alreadyUnlocked': 'Premium er allerede låst opp.',
  'premium.nothingToRestore': 'Fant ingen Google Play-kjøp. Gjenopprett i Android-appen hvis du allerede har kjøpt Premium.',
  'premium.webOnly': 'Kjøp håndteres av Google Play i Android-appen. Denne siden belaster deg ikke.',
  'premium.error': 'Kunne ikke fullføre forespørselen. Prøv igjen, eller gjenopprett kjøpet.',
  'premium.cancelled': 'Kjøpet ble avbrutt.',
  'premium.teaserTitle': 'Flere ord og setninger',
  'premium.teaserBody': 'Premium legger til mer hverdagsvokabular og reisesetninger. Én gangs opplåsning, for alltid.',
  'premium.lockedItem': 'Premium',
  'premium.unlockedBadge': 'Premium låst opp',
  'premium.devHint': 'Kun for utvikling: localStorage-nøkkelen polytalk-premium=1 låser opp ekstrapakken. Dette er ikke en ekte betaling.',
...
const KO_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.title': '프리미엄',
  'premium.statusUnlocked': '프리미엄이 해제되었습니다. 추가 단어, 숫자, 문장이 포함됩니다.',
  'premium.statusLocked': '여행용 추가 단어, 숫자, 문장을 해제하세요',
  'premium.pitch': 'Google Play에서 한 번만 결제하고 일상 어휘를 더 받으세요. 구독이 아닙니다.',
  'premium.buy': '프리미엄 해제',
  'premium.buyOnPlay': 'Google Play에서 구매',
  'premium.restore': '구매 복원',
  'premium.restoring': '복원하는 중...',
  'premium.purchasing': 'Google Play를 여는 중...',
  'premium.restored': '구매를 복원했습니다.',
  'premium.alreadyUnlocked': '프리미엄이 이미 해제되어 있습니다.',
  'premium.nothingToRestore': 'Google Play 구매를 찾지 못했습니다. 이미 구매했다면 Android 앱에서 복원하세요.',
  'premium.webOnly': '결제는 Android 앱의 Google Play에서 처리됩니다. 이 페이지는 결제하지 않습니다.',
  'premium.error': '요청을 완료할 수 없습니다. 다시 시도하거나 구매를 복원하세요.',
  'premium.cancelled': '구매가 취소되었습니다.',
  'premium.teaserTitle': '더 많은 단어와 문장',
  'premium.teaserBody': '프리미엄은 일상 어휘와 여행 문장을 추가합니다. 한 번 해제하면 계속 사용할 수 있습니다.',
  'premium.lockedItem': '프리미엄',
  'premium.unlockedBadge': '프리미엄 해제됨',
  'premium.devHint': '개발 전용: localStorage 키 polytalk-premium=1 로 추가 팩을 해제할 수 있습니다. 실제 결제가 아닙니다.',
...
const HI_TRANSLATIONS: TranslationKeys = {
  ...
  'premium.title': 'प्रीमियम',
  'premium.statusUnlocked': 'प्रीमियम अनलॉक है। अतिरिक्त शब्द, संख्याएँ और वाक्य शामिल हैं।',
  'premium.statusLocked': 'अधिक यात्रा शब्द, संख्याएँ और वाक्य अनलॉक करें',
  'premium.pitch': 'Google Play पर एक बार खरीदकर अधिक रोज़मर्रा की शब्दावली पाएँ। यह सदस्यता नहीं है।',
  'premium.buy': 'प्रीमियम अनलॉक करें',
  'premium.buyOnPlay': 'Google Play पर खरीदें',
  'premium.restore': 'खरीद रिस्टोर करें',
  'premium.restoring': 'रिस्टोर हो रहा है...',
  'premium.purchasing': 'Google Play खुल रहा है...',
  'premium.restored': 'खरीद रिस्टोर हो गई।',
  'premium.alreadyUnlocked': 'प्रीमियम पहले से अनलॉक है।',
  'premium.nothingToRestore': 'कोई Google Play खरीद नहीं मिली। अगर आप पहले खरीद चुके हैं तो Android ऐप में रिस्टोर करें।',
  'premium.webOnly': 'खरीद Android ऐप में Google Play संभालता है। यह पेज आपसे शुल्क नहीं लेगा।',
  'premium.error': 'अनुरोध पूरा नहीं हो सका। फिर कोशिश करें, या खरीद रिस्टोर करें।',
  'premium.cancelled': 'खरीद रद्द हुई।',
  'premium.teaserTitle': 'और शब्द और वाक्य',
  'premium.teaserBody': 'प्रीमियम रोज़मर्रा की शब्दावली और यात्रा वाक्य जोड़ता है। एक बार अनलॉक, हमेशा के लिए।',
  'premium.lockedItem': 'प्रीमियम',
  'premium.unlockedBadge': 'प्रीमियम अनलॉक',
  'premium.devHint': 'केवल विकास: localStorage कुंजी polytalk-premium=1 अतिरिक्त पैक खोलती है। यह असली भुगतान नहीं है।',
